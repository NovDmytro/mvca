...
<template id="terminalTMPL">
  <style>
    ...
    /*body {*/
    /*    padding-bottom: var(--body-margin-bottom);*/
    /*}*/
    ...
    .git .mvca-terminal .resize-top-side {
      width: 100%;
      height: 10px;
      background-color: var(--mvca-terminal-bg-color);
      cursor: row-resize;
  ...
  <section class="mvca-terminal">
    ...
    <div class="mvca-terminal-navigation">
      ...
      <div class="mvca-terminal-navigation-status-bar">
        ...
        <svg class="mvca-terminal-folder-icon hide" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
        ...
        <div class="mvca-terminal-navigation-buttons-set">
          <svg data-terminal="up" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
          ...
          <svg data-terminal="center" xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
            <path d="M450-80v-800h60v800h-60Zm120-210v-380h100v380H570Zm-280 0v-380h100v380H290Z"/>
          </svg>
          <svg data-terminal="close" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
  ...
  <script>
    window.addEventListener('DOMContentLoaded', () => {
      ...
      const observer = new IntersectionObserver(hideFolderAtIntersect, {
        root: terminal,
        rootMargin: '0px',
        threshold: 0.99,
      });
...
<script>
  const terminala = document.getElementById("terminala");
  const terminalTMPL = document.getElementById("terminalTMPL");
