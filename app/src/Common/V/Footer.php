            ...
            <div class="container">
                <div class="footer__logo-container">
                    ...
                    <div class="footer__logo-text-container">
                        <span class="footer__logo-text-header">Footer LLC</span>
                        <span class="footer__logo-text-route">Footer: src/view/template/common/footer.php</span>
                    </div>
                </div>
            </div>
        </footer>
    ...
    <section class="mvca-terminal">
        ...
        <div class="mvca-terminal-navigation">
            <ul class="mvca-terminal-folders">
                <li data-folder="internal-errors" class="mvca-terminal-folder active">Internal Errors</li>
                <li data-folder="php-errors" class="mvca-terminal-folder">PHP errors</li>
            </ul>
        ...
        <div class="mvca-terminal-error-area internal-errors">
            <pre>
&lt;&lt;here Internal errors
            </pre>
        </div>
        <div class="mvca-terminal-error-area php-errors hide">
            <pre>
&lt;&lt;here PHP errors
            </pre>
        </div>
