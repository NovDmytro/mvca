<section class="post-request">
    ...
    <p class="sample__text sample__subheader">Fillup form and <span class="important"> 'Click'</span> the submit button to <span class="positive">POST</span> behaviour test.</p>
    <div class="sample__container">
        <div class="sample-request__left">
            <form class="sample__form" method="post">
                ...
                <label class="sample__label" for="sample-upper">Trasnform to upper case
    ...
    <section class="subsection">
		...
		<p class="sample__text">Accesion to variable pattern: <span class="important">&lt;?= $postSample['upCaseSample'] ?&gt;</span> </p>
		<p class="sample__text">Aviability provide array <span class="important">$view['postSample']['upCaseSample']</span>. Parent's <span class="important">['postSample']['upCaseSample']</span> transform into <span class="important">$postSample['upCaseSample']</span>  </p>
