<section class="get-request">
	...
	<div class="sample__container">
		<div class="sample-request__left">
			...
			<p class="sample__text">Routes and dirs customization at <span class="route">app/public/.htaccess</span>. You are able to modify amount of available dirs and names of variables such as <span class="positive">'route' </span> and <span class="positive">'var1-6'</span>. <span class="warning">Beware</span> of change names in ongoing project: cascade changes at all pages need.</p>
		</div>
	...
	<section class="subsection">
		...
		<p class="sample__text">Accession to variable pattern: <span class="important">&lt;?= $dirs['dirName'] ?&gt;</span> </p>
		<p class="sample__text">Availability provide array <span class="important">$view['dirs']['dirName']</span>. Parent's <span class="important">['dirs']['dirName']</span> transform into <span class="important">$dirs['dirName']</span>  </p>
