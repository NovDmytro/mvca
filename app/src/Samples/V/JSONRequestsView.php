<section class="json-request">
    ...
    <p class="sample__text sample__subheader">Fill up form and <span class="important"> 'Click'</span> the submit button to <span class="positive">JSON</span> behaviour test.</p>
        ...
        <div class="sample-request__left">
            <form class="sample__form">
                ...
                <label class="sample__label" for="id">id
                    <input class="sample__input" name='id' type="text" id="id" value="123MVCAmvca=);+1#%*">
                </label>
    ...
    <section class="subsection">
        ...
        <p class="sample__text">Request and variable call pattern: <span class="important">$request->JSON(<span class="route">'parameter'</span>, <span class="route">'filter'</span>, <span class="route">'case'</span>)]);</span>. Second and third parameters of MVCA POST Request are optional and usefull for sanitizing.</p>
    ...
    <section class="subsection">
		...
		<p class="sample__text">MVCA JSON Request inframework service which react on conditions for example if pass <span class="important">$request->GET('jsonDemo') == 'yes'</span> as in sample upper.</p>
